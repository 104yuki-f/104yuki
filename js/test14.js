...
window.onload=()=>{
	const words=[
		...
		['～を展示する','display','display.jpg'],
		['～を信頼する','trust','trust.jpg'],
		['（～）次第である','depend','depend.jpg'],
		['（～に）頼る','rely','rely.jpg'],
		['祈る','pray','pray.jpg'],
		['～を嘆願する','beg','beg.jpg'],
		...
		['（～を）心配して','anxious','anxious.jpg'],
		['～を満足させる','satisfy','satisfy.jpg'],
		['～をいらだたせる','annoy','annoy.jpg'],
		['～に面倒をかける','bother','bother.jpg'],
		['（うるさくして）～に迷惑をかける','disturb','disturb.jpg'],
		['～をおびえさせる','frighten','frighten.jpg'],
		['～を動揺させる','upset','upset.jpg'],
		...
		['方法(w)','way','way.jpg'],
		['方法(m)','manner','manner.jpg'],
		['目的','purpose','purpose.jpg'],
		['ため','sake','sake.jpg'],
		['ちょうど','right','right.jpg'],
		['完全な','complete','complete.jpg'],
		['ほとんど～ない','hardly','hardly.jpg'],
		['ほとんど','nearly','nearly.jpg'],
		['ある程度，部分的に','partly','partly.jpg'],
		['実は','actually','actually.jpg'],
		['（強調として）実際に，本当に','indeed','indeed.jpg'],
		['さえも','even','even.jpg'],
		['正確に','exactly','exactly.jpg'],
