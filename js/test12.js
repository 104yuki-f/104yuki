...
window.onload=()=>{
	const words=[
		...
		['当然の','natural','natural.jpg'],
		['確かな','certain','certain.jpg'],
		['おそらく','probably','probably.jpg'],
		['〜に直面する','face','face.jpg'],
		['～を避ける','avoid','avoid.jpg'],
		['～を解決する','solve','solve.jpg'],
		['問題、ごたごた','trouble','trouble.jpg'],
		['問題','issue','issue.jpg'],
		['〜に声援を送る','cheer','cheer.jpg'],
		['に促す、奨励する','encourage','encourage.jpg'],
		...
		['起こる','happen','happen.jpg'],
		['現れる','appear','appear.jpg'],
		['～のままでいる','remain','remain.jpg'],
		['生き残る','survive','survive.jpg'],
		['所属している','belong','belong.jpg'],
		['〜を代表する','represent','represent.jpg'],
		['～の基礎を置く','base','base.jpg'],
		['～を含む','include','include.jpg'],
		['〜を含む','contain','contain.jpg'],
		['自分自身の','own','own.jpg'],
		['〜を共有する','share','share.jpg'],
		['を集める 集まる','collect','collect.jpg'],
		['〜を集める','gather','gather.jpg'],
		...
		['～を理解する','realize','realize.jpg'],
		['〜を理解する','appreciate','appreciate.jpg'],
